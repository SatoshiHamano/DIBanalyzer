...
if __name__ == "__main__":
    ...
    parser.add_argument("objectID", type=int, help="object ID")
    parser.add_argument("DIBID", type=int, help="DIB ID")
    ...
    cur.execute("SELECT x.combineID, x.measurementID, x.DIBID, x.echelleorder, x.DIBspecpath, "
                ...
                "from DIBmeasurement as x join combinesummary as y using(combineID) where y.objectID=%d and x.DIBID=%d;" % (
                    objectID, DIBID))
    rows = cur.fetchall()
