...
from correlation_dibpair import DIBcorrelation, Vcorrelation, DIBcorrelation2
...
if __name__ == "__main__":
    ...
    # objectIDinput = [37,43,50,34,90,124,12,13,14,10,11,8,138,23,123,55,22,59,27,246,29,30,63,31,32,33,35,39,40,41,42,66,
    ...
    for i in [33,34,35,37,38]:
        ...
        for j in [33,34,35,37,38]:#DIBset:
            if i != j:
                req = DIBID == j
                num = numpy.sum(req)
                ...
                if numpy.sum(detection12) >= 10:
                    ...
                    dibax = plt.axes()
                    r_dib, p_dib, n_dib, _, _ = DIBcorrelation(dibax, ewdict1, ewerrdict1, objIDpf1, wav_air[i], ewdict2,
