...
def collect_info(pipeline_direc):
    ...
    if os.path.exists(pipeline_direc + "reduction_log/"):
        ...
        if os.path.exists(pipeline_direc + "reduction_log/cosmicray_log.txt"):
            bplogf = open(pipeline_direc + "reduction_log/cosmicray_log.txt", "r")
        ...
        if len(glob.glob(pipeline_direc + "reduction_log/*.tex")) > 0:
            ...
            for i in texlogl:
                ...
                if pipelineflag:
                    ...
                    if i.find("Cosmic ray correction") != -1:
