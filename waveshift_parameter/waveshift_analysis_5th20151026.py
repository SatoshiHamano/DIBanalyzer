...
if __name__ == "__main__":
    ...
    cur.execute(
        "select pipelineID, FrameNum, totalSNR, mode, obsdate, path, pipelinever from datareduction where obsdate between '2015-10-22 00:00:00' and '2015-10-31 00:00:00';")
    rows = cur.fetchall()
    ...
    wf = open("waveshift_analysis_5th20151026_ver3.7.dat", "w")
