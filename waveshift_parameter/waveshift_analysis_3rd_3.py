...
if __name__ == "__main__":
    ...
    cur.execute(
        "select pipelineID, FrameNum, totalSNR, mode, obsdate, path from datareduction where obsdate between '2013-11-20 00:00:00' and '2014-02-01 00:00:00';")
    rows = cur.fetchall()
    ...
    rf = open("waveshift_parameter_3rdrun_3.5.dat", "r")
    rl = rf.readlines()
    rf.close()
    ...
    pp = PdfPages("waveshift_analysis_3rd_3.pdf")
    plt.figure()
