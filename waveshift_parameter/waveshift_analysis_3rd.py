...
if __name__ == "__main__":
    ...
    cur.execute(
        "select pipelineID, FrameNum, totalSNR, mode, obsdate, path, pipelinever from datareduction where obsdate between '2013-11-20 00:00:00' and '2014-02-01 00:00:00';")
    rows = cur.fetchall()
    ...
    wf = open("waveshift_analysis_3rd_ver3.5.dat", "w")
