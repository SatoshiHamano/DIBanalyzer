...
if __name__ == "__main__":
    ...
    cur.execute(
        "select pipelineID, FrameNum, totalSNR, mode, obsdate, path, pipelinever from datareduction where obsdate between '2017-07-01 00:00:00' and '2017-08-01 00:00:00' and mode='WIDE';")
    rows = cur.fetchall()
    ...
    wf = open("waveshift_analysis_NTT17c_ver3.6.dat", "w")
